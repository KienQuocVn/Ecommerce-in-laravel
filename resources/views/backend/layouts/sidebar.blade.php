<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    <a class="nav-link" href="{{route('file-manager')}}">
      ...
      <span>Quản lý phương tiện truyền thông</span></a>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="{{route('banner.index')}}">Biểu ngữ</a>
  ...
  <li class="nav-item">
    ...
    <div id="productCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="{{route('product.create')}}">Thêm Các sản phẩm</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="{{route('post-tag.index')}}">Nhãn</a>
  ...
  <!-- Live Stream -->
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#livestreamCollapse" aria-expanded="true" aria-controls="livestreamCollapse">
      <i class="fas fa-video"></i>
      <span>Live Stream</span>
    </a>
    <div id="livestreamCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Quản lý Live Stream:</h6>
        <a class="collapse-item" href="{{route('admin.livestream.index')}}">Danh sách Live Stream</a>
        <a class="collapse-item" href="{{route('admin.livestream.create')}}">Tạo Live Stream Mới</a>
      </div>
    </div>
  </li>
