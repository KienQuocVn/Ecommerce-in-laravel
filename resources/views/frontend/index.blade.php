...
@section('title','SHOPFY || TRANG CHỦ')
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item {{(($key==0)? 'active' : '')}}">
            ...
            <div class="carousel-caption d-none d-md-block text-left">
                ...
                <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{route('product-lists')}}" role="button">Mua ngay<i class="far fa-arrow-alt-circle-right"></i></i></a>
            </div>
        </div>
        @endforeach
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        $after_discount=($product->price-($product->price*$product->discount)/100)
                                        @endphp
                                        <p class="price with-discount">{{number_format($after_discount,0)}} VNĐ</p>
                                    </div>
                                </div>
                            </div>
                        </div>
