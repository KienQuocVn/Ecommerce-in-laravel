...
@section('title','SHOPFY || Trang chi tiết blog')
            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="javascript:void(0);">Trang chi tiết blog </a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="blog-single-main">
                    <div class="row">
                            ...
                            <div class="blog-detail">
                                ...
                                <div class="blog-meta">
                                    <span class="author">
                                        ...
                                        <a href="javascript:void(0);">
                                            <i class="fa fa-comments"></i>Bình luận ({{$post->allComments->count()}})
                                        </a>
                                    </span>
                                </div>
                                    ...
                                    <form class="form comment_form" id="commentForm" action="{{route('post-comment.store',$post->slug)}}" method="POST">
                                        ...
                                        <div class="row">
                                            {{-- <div class="col-lg-6 col-md-6 col-12">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label>Email của bajn<span>*</span></label>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group button">
                                                    <button type="submit" class="btn">
                                                        <span class="comment_btn comment">Đăng bình luận</span>
                                                        <span class="comment_btn reply" style="display: none;">Trả lời Bình luận</span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <p class="text-center p-5">
                            Bạn cần phải
                            <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a> để bình luận.
                        ...
                        <div class="letter-inner">
                            ...
                            <form action="{{route('subscribe')}}" method="POST">
                                ...
                                <div class="form-inner">
                                    ...
                                    <button type="submit" class="btn mt-2">Lưu</button>
                                </div>
                            </form>
                        </div>
                    </div>
