				...
				<div class="total-amount">
					<div class="row">
						...
						<div class="col-lg-4 col-md-7 col-12">
							<div class="right">
								<ul>
									<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Tổng giá giỏ hàng<span>{{number_format(Helper::totalCartPrice(),0)}} VNĐ</span></li>
									...
									@endphp
									@if(session()->has('coupon'))
									<li class="last" id="order_total_price">Tổng tiền<span>{{number_format($total_amount,0)}} VNĐ</span></li>
									@else
									<li class="last" id="order_total_price">Tổng tiền<span>{{number_format($total_amount,0)}} VNĐ</span></li>
									@endif
								</ul>
