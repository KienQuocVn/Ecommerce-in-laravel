...
@section('title','SHOPFY || TRANG SẢN PHẨM')
                        ...
                        <div class="col-12">
                            ...
                            <div class="shop-top">
                                <div class="shop-shorter">
                                    ...
                                    <div class="single-shorter">
                                        <a href="{{route('product-grids')}}" class="btn btn-sm btn-danger">
                                ...
                                @endphp
                                <ul class="view-mode">
                                    <li class="{{ $activeView === 'grid' ? 'active' : '' }}"><a href="{{ $activeView === 'grid' ? 'javascript:void(0)' : $gridUrl }}"><i class="fa fa-th-large"></i></a></li>
                                    <li class="{{ $activeView === 'list' ? 'active' : '' }}"><a href="{{ $listUrl }}"><i class="fa fa-th-list"></i></a></li>
                                </ul>
                            </div>
                            <!--/ End Shop Top -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="alert alert-warning text-center" style="margin:50px auto;">
                                ...
                                <a href="{{route('product-grids')}}" class="btn btn-primary">Xóa bộ lọc</a>
                            </div>
                        </div>
                        @endif
                    </div>
