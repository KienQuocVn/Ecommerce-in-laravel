                    ...
                    <div class="order-details">
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                ...
                                $initialTotal = max(0, $cartTotal - $couponValue);
                                @endphp
                                <ul>
                                    ...
                                    @endif
                                    <li class="last" id="order_total_price" data-base-total="{{$initialTotal}}">Tổng cộng<span>{{number_format($initialTotal,0)}} VNĐ</span></li>
                                </ul>
                            </div>
                        </div>
                        <!--/ End Order Widget -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        const baseTotal = parseFloat($orderTotal.data('base-total')) || (subtotal - (parseFloat($('.coupon_price').data('price')) || 0));
        ...
        const applyShippingChange = () => {
            ...
            const total = Math.max(0, baseTotal + cost);

            $shippingCostDisplay.attr('data-price', cost.toFixed(2)).text(formatCurrency(cost));
